...
// - 역할: 현재 씬 안의 루트 오브젝트부터 필요한 배우와 컴포넌트를 제한적으로 조회합니다.
// - 영화 비유: 무대 전체를 무작정 뒤지는 방식 대신, 현재 열린 극장의 무대 목록표를 위에서부터 확인하는 진행 스태프입니다.
// - 유지보수 포인트: 전역 오브젝트 검색을 한 곳으로 대체해 의도하지 않은 다른 그룹 배우가 잡히는 문제를 줄입니다.
// =============================================================================
