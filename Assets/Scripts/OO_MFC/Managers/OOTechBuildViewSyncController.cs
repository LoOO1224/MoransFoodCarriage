...
// - 역할: 빌드된 exe에서 Editor Game View와 최대한 같은 1920x1080 기준 화면을 유지합니다.
// - 영화 비유: 극장 상영본의 스크린 비율과 조명 기준을 리허설 룸(Game View)과 맞추는 상영 기사입니다.
// - 유지보수 포인트: 장면 큐를 지휘하지 않습니다. 해상도, CanvasScaler, 커서, timeScale 같은 상영 환경만 점검합니다.
// =============================================================================
