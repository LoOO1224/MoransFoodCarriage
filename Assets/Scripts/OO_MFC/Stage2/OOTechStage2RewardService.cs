...
// - 역할: Stage2Group의 임무 텍스트 갱신과 보상 지급을 담당합니다.
// - 영화 비유: 무대감독이 직접 소품 창고를 뒤지지 않고, 보상/소품 담당에게 "꿀 지급, 임무 갱신"을 맡깁니다.
// - 유지보수 포인트: 퀘스트 문장은 OO_StageQuest 데이터에서 읽고, 인벤토리 변경은 GameManager에만 요청합니다.
// =============================================================================
